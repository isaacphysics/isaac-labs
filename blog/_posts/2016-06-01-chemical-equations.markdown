...
<code style="font-size: 1rem;display:block;text-align:center;">3CH3(CH2)2OH(l) + Cr2O7^{2-}(aq) + 8H+ -> 3CH3CH2CHO(l) + 2Cr3^{+}(aq) + 7H2O(g)</code>

becomes

$$\ce{3CH3(CH2)2OH(l) + Cr2O7^{2-}(aq) + 8H+ -> 3CH3CH2CHO(l) + 2Cr3^{+}(aq) + 7H2O(g)}$$
